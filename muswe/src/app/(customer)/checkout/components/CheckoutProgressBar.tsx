  ...
  return (
    ...
    >
      <Link href="/cart" role="listitem" className="flex items-center space-x-2 group">
        <div className="w-5 h-5 rounded-full border border-neutral-300 flex items-center justify-center text-xs text-neutral-400 font-sans group-hover:border-brand-black group-hover:text-brand-black transition-colors">
          1
        </div>
      ...
      >
        <div
          className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-sans font-semibold ${checkoutStep === 'shipping' ? 'bg-brand-gold text-white shadow-[0_0_10px_rgba(154,123,79,0.3)]' : 'border border-neutral-300 text-neutral-400'}`}
        >
          2
        </div>
        <span
      ...
      >
        <div
          className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-sans font-semibold ${checkoutStep === 'payment' ? 'bg-brand-gold text-white shadow-[0_0_10px_rgba(154,123,79,0.3)]' : 'border border-neutral-300 text-neutral-400'}`}
        >
          3
        </div>
        <span
