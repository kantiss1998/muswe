...
export function CategoriesClient({ parentCategories }: CategoriesClientProps): React.JSX.Element {
  const { isEnglish } = useTranslation()

  return (
    <div className="bg-white min-h-screen">
      <PageHero
        eyebrow={isEnglish ? 'Categories List' : 'Daftar Kategori'}
        title={isEnglish ? 'Curated Categories' : 'Kategori Pilihan'}
        subtitle={
          isEnglish
            ? 'Explore our finest modest fashion collections grouped by category.'
            : 'Temukan koleksi busana muslim terbaik berdasarkan kategori pilihan Anda.'
        }
      />
