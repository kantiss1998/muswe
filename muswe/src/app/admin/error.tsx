  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-stone-50 font-sans">
      <div className="max-w-md bg-white border border-neutral-200 p-8 shadow-sm space-y-6">
        ...
        {error.digest && (
          <p className="text-xs text-neutral-400 bg-neutral-50 p-2 border border-neutral-100 font-mono select-all">
            ID: {error.digest}
          </p>
        )}
        <div className="flex justify-center space-x-3 pt-2">
          <button
            onClick={() => reset()}
            className="px-5 py-2 bg-neutral-900 text-white hover:bg-neutral-800 text-xs font-heading font-medium uppercase tracking-wider transition"
          >
            Coba Lagi
          </button>
          <Link
            href="/admin"
            className="px-5 py-2 border border-neutral-300 text-neutral-700 hover:bg-neutral-50 text-xs font-heading font-medium uppercase tracking-wider transition"
          >
            Dashboard Admin
          </Link>
        </div>
