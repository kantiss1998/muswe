...
export async function calculateShippingRatesAction(
  destinationPostalCode: string,
  weightGram: number,
  destinationCountryCode?: string
) {
  return shippingService.calculateShippingRates(destinationPostalCode, weightGram, undefined, destinationCountryCode)
}
